...
const RefreshLevel = Object.freeze({
  NONE: 0,
  PAINT: 1,
  RESIZE: 2,
  REGENERATE: 3
...
class QEDObject {
  ...
  _qedSetBlockingCall(blockingCall) {
    if (!this.blocking__Call) {
      ...
      this.blocking__Call.refreshLevel = RefreshLevel.REGENERATE;
    }
  }
  ...
  _qedEndCall() {
    if (this.blocking__Call) {
      ...
      this.refreshLevel = this.blocking__Call.refresh_Model_ ? RefreshLevel.PAINT : RefreshLevel.NONE;
  ...
  _refreshModels() {
    this.refreshLevel = this.refresh_Model_ ? Math.max(this.refreshLevel, this.refresh_Model_()) : RefreshLevel.NONE;

    if (this.blocking__Call) {
      const blockingLevel = this.blocking__Call._refreshModels();

      if (blockingLevel != RefreshLevel.NONE && blockingLevel != RefreshLevel.REGENERATE)
        this.refreshLevel = Math.max(this.refreshLevel, RefreshLevel.PAINT);

      return Math.max(this.refreshLevel, blockingLevel);
    }
    else
...
class QEDBasicArray extends Array {
  ...
  _refreshModels = function() {
    ...
    let level = length != this.oldLength ? RefreshLevel.RESIZE : RefreshLevel.NONE;
...
canvas.addEventListener("click", function(ev) {
  ...
  Main_$this.onGlobalEvent(2, [canvasX, canvasY]);
});
if (pointerSupported)
...
;
this.logFast = function (str, fast) {
  if (fast)
    Main_$this.println(str);
};
this.pushCanvas = function (pos0, pos1, size0, size1) {
  if (!Main_$this.cvCount++) {
    ctx = canvasCtx
    canvasCtx.drawImage(bgCanvas, pos0, pos1, size0, size1, pos0, pos1, size0, size1);
  }
};
this.popCanvas = function () {
  if (! -- Main_$this.cvCount)
    ctx = origCtx;
};
...
this.QedRect = class QedRect extends QEDObject {
  constructor(x, y, width, height, context__Call) {
    ...
    this.width = width;
    this.height = height;
    const QedRect$this = this;
  }
};
this.newQedRect = function (width, height) {
  return (new Main_$this.QedRect(0, 0, width, height, Main_$this));
};
...
//  Main_$this.logFast("" + refreshCount++ + "- Refresh Level: " + level, true);
  ...
  if (level != RefreshLevel.NONE) {
    ...
    if (!fastFlag || level >= RefreshLevel.RESIZE) {
      if (!fastFlag || !Main_$this.windows)// || !Main_$this.windows.length)
        Main_$this.windows = _refreshViews(obj, []);

      if (Main_$this.windows.length) {
        Main_$this.windows[0].recalcLayout();
...
//    if (!fastFlag)
    ...
    if (Main_$this.windows.length)
      Main_$this.windows[0].paint(x, y, canvas.width, canvas.height, fastFlag);
  };
};
...
this.executeEvents_ = function () {
  let mainObjActive = Main_$this.MainObj && Main_$this.MainObj.active;

  while (Main_$this.MainObj && Main_$this.MainObj.active && postHandler != null)
  ...
  if (Main_$this.MainObj && Main_$this.MainObj.active)
...
this.QedAnimation = class QedAnimation extends QEDObject {
  constructor(context__Call) {
    ...
    this.requestId = requestAnimationFrame((timeStampMs) => {
  ...
  constructor(Init, numDim, dirs, Ui_) {
    ...
    this.Insert = class Insert extends QEDObject {
      constructor(pos, size, context__Call) {
        ...
        Insert$this._qedSetBlockingCall(_bindHandler(new SQEDArray$this.InsertLevel(SQEDArray$this, SQEDArray$this.dims, this.pos, this.size, this.newSize, new Array(this.size.length).fill(0), 0, Insert$this.context__Call), (function Lambda_ () {
          if (!Insert$this._isActive())
            return;
          Insert$this._qedEndCall();
          SQEDArray$this.dims = Insert$this.newSize;
          {
            Main_$this.post_(Insert$this, SQEDArray$this);
            return;
          }
        })));
      }
          ...
          if (InsertLevel$this.level < SQEDArray$this.dims.length - 1) {
            {
              ...
              (function while26$_ () {
                if (pp[level] < pos[level]) {
                  InsertLevel$this._qedSetBlockingCall(_bindHandler(new SQEDArray$this.InsertLevel(array[pp[level]], InsertLevel$this.dims, InsertLevel$this.pos, InsertLevel$this.size, InsertLevel$this.newSize, InsertLevel$this.pp, InsertLevel$this.level + 1, InsertLevel$this.context__Call), (function Lambda_ () {
            ...
            }
            {
              ...
              (function while34$_ () {
                if (pp[level] < pos[level] + InsertLevel$this.size[level]) {
                  InsertLevel$this._qedSetBlockingCall(_bindHandler(new SQEDArray$this.Init(InsertLevel$this.pp, InsertLevel$this.context__Call), (function Lambda_ (_ret35$_) {
                    if (!InsertLevel$this._isActive())
                      return;
                    InsertLevel$this._qedEndCall();
                    array[pp[level]] = _ret35$_;
                    pp[level]++;
                    while34$_();
                  })));
                }
    ...
    this.Push = class Push extends QEDObject {
      constructor(context__Call) {
        ...
        this.size[0] = 1;
        Push$this._qedSetBlockingCall(_bindHandler(new SQEDArray$this.Insert(this.pos, this.size, Push$this.context__Call), (function Lambda_ (_ret41$_) {
          if (!Push$this._isActive())
            return;
          Push$this._qedEndCall();
          {
            Main_$this.post_(Push$this, SQEDArray$this);
            return;
          }
        })));
      }
  ...
  constructor(Init, numDim) {
    ...
    this.Insert = class Insert extends QEDObject {
      constructor(pos, size, context__Call) {
        ...
        Insert$this._qedSetBlockingCall(_bindHandler(new VSQEDArray$this.InsertLevel(VSQEDArray$this.dims, this.pos, this.size, this.newSize, new Array(this.size.length).fill(0), 0, Insert$this.context__Call), (function Lambda_ () {
          if (!Insert$this._isActive())
            return;
          Insert$this._qedEndCall();
          ...
          if (InsertLevel$this.level < VSQEDArray$this.dims.length - 1) {
            {
              ...
              (function while44$_ () {
                if (pp[level] < pos[level]) {
                  InsertLevel$this._qedSetBlockingCall(_bindHandler(new VSQEDArray$this.InsertLevel(InsertLevel$this.dims, InsertLevel$this.pos, InsertLevel$this.size, InsertLevel$this.newSize, InsertLevel$this.pp, InsertLevel$this.level + 1, InsertLevel$this.context__Call), (function Lambda_ () {
                    if (!InsertLevel$this._isActive())
                      return;
                    InsertLevel$this._qedEndCall();
                    pp[level]++;
                  ...
                  (function while45$_ () {
                    if (pp[level] < pos[level] + InsertLevel$this.size[level]) {
                      array[pp[level]] = [];
                      InsertLevel$this._qedSetBlockingCall(_bindHandler(new VSQEDArray$this.InsertLevel(new Array(InsertLevel$this.size.length).fill(0), new Array(InsertLevel$this.size.length).fill(0), InsertLevel$this.newSize, InsertLevel$this.newSize, InsertLevel$this.pp, InsertLevel$this.level + 1, InsertLevel$this.context__Call), (function Lambda_ () {
                        if (!InsertLevel$this._isActive())
                          return;
                        InsertLevel$this._qedEndCall();
                        pp[level]++;
            ...
            (function while50$_ () {
              if (pp[level] < pos[level] + InsertLevel$this.size[level]) {
                InsertLevel$this._qedSetBlockingCall(_bindHandler(new VSQEDArray$this.Init(InsertLevel$this.pp, InsertLevel$this.context__Call), (function Lambda_ () {
                  if (!InsertLevel$this._isActive())
                    return;
                  InsertLevel$this._qedEndCall();
                  pp[level]++;
...
this.paintView = function (viewObj, posx, posy, sizex, sizey, fast) {
};
...
this.ViewArray_ = function (array, dirs, resizeViewFn, paintViewFn, onViewEventFn, getViewElementRectFn) {
  this.array = array;
  this.dirs = dirs;
  ...
  this.recalcLayout = function () {
    let length = ViewArray_$this.array.size();
    let space = _spacing;
    {
      let index = 0;
      while(index < length) {
        let elementSize = ViewArray_$this.resizeViewFn(ViewArray_$this.array[index]);
        ViewArray_$this.posSet[index] = new Main_$this.QEDExplicitArray(0, 0);
        {
          let dir = 0;
          while(dir < 2) {
            ViewArray_$this.posSet[index][dir] = (ViewArray_$this.dirs[dir] ? ((index ? ViewArray_$this.size[dir] + space : 0)) + elementSize[dir] : Main_$this.max(ViewArray_$this.size[dir], elementSize[dir]));
            ViewArray_$this.size[dir] = ViewArray_$this.posSet[index][dir];
            dir++;
          }
        }
        index++;
  ...
  this.paint = function (pos0, pos1, size0, size1, fast) {
    let length = ViewArray_$this.array.size();
    let space = _spacing;
      ...
      while(index < length) {
        {
          ...
          while(dir < 2) {
            if (ViewArray_$this.dirs[dir]) {
              let relPos = (index ? ViewArray_$this.posSet[index - 1][dir] + space : 0);
        ...
        ViewArray_$this.paintViewFn(ViewArray_$this.array[index], pos[0], pos[1], size[0], size[1], fast);
        index++;
      }
    }
  };
      ...
      while(index >= 0) {
        {
          ...
          while(dir < 2) {
            if (ViewArray_$this.dirs[dir]) {
              pos[dir] = (index ? ViewArray_$this.posSet[index - 1][dir] + space : 0);
        ...
        if (pos0 >= pos[0] && pos0 < pos[0] + size[0] && pos1 >= pos[1] && pos1 < pos[1] + size[1]) {
          pos0 -= pos[0];
          pos1 -= pos[1];
          return (ViewArray_$this.onViewEventFn(ViewArray_$this.array[index], event, pos0, pos1, size[0], size[1]));
        }
        index--;
      }
    }
  ...
  this.getBoundsRect = function (path, index, pos0, pos1, size0, size1, level, dLevel) {
    let space = _spacing;
    let ndx = index[0];
    let relPos = (ndx ? ViewArray_$this.posSet[ndx - 1][0] + space : 0);
    ...
    if (level < path.size() || dLevel < index.size())
      return (ViewArray_$this.getViewElementRectFn(ViewArray_$this.array[ndx], path, index, posx, posy, sizex, sizey, level, dLevel));
    else
...
this.resizeViewObj = function (unit) {
  ...
  return ((windows.size() ? windows[0].size : new Main_$this.QEDExplicitArray(0, 0)));
};
this.paintViewObj = function (viewObj, posx, posy, sizex, sizey, fast) {
  let window = viewObj;
  if (window.size())
...
this.paintViewString = function (viewObj, posx, posy, sizex, sizey, fast) {
  Main_$this.displayText(viewObj, posx, posy, sizex, sizey);
};
...
this.paintViewImage = function (viewObj, posx, posy, sizex, sizey, fast) {
  Main_$this.displayImage(viewObj, posx, posy, sizex, sizey);
};
...
this.Directive_ = function (direction, atts, children) {
  ...
  this.clearChange = function () {
    Directive_$this.changeLevel = RefreshLevel.NONE;
    {
      let index = 0;
  ...
  this.refreshChange = function () {
    Directive_$this.subChangeLevel = 0;
    {
      let index = 0;
      while(index < Directive_$this.children.size()) {
        Directive_$this.subChangeLevel = Main_$this.max(Directive_$this.subChangeLevel, Directive_$this.children[index].refreshChange());
        index++;
      }
    }
    return (Main_$this.max(Directive_$this.changeLevel, Directive_$this.subChangeLevel));
  };
  this.setAtt = function (index, value) {
    let att = Directive_$this.atts[index];
    if (!Main_$this.qedEqual(value, att.value)) {
      Directive_$this.changeLevel = Main_$this.max(Directive_$this.changeLevel, (att.code > Main_$this.QED_TAG_HERITABLE ? RefreshLevel.PAINT : (att.code > Main_$this.QED_TAG_AREA_HERITABLE ? RefreshLevel.RESIZE : RefreshLevel.REGENERATE)));
  ...
  this.refreshOutModel = function () {
    let outModel = Directive_$this.outAttr[0].value;
    if (outModel != null) {
      let objChangeLevel = outModel._refreshModels();
      objChangeLevel = Main_$this.min(RefreshLevel.RESIZE, objChangeLevel);
      Directive_$this.changeLevel = Main_$this.max(Directive_$this.changeLevel, objChangeLevel);
    }
  };
  ...
  this.changeLevel = RefreshLevel.NONE;
  this.subChangeLevel = RefreshLevel.NONE;
  this.outType = -1;
  this.outNumDim = 0;
  {
    let ndx = 0;
...
this.Widget_ = function (directive) {
  ...
  this.recalcLayout = function () {
    if (Widget_$this.directive.changeLevel >= RefreshLevel.RESIZE && Widget_$this.outType >= 0) {
      let outModel = Widget_$this.directive.outAttr[0].value;
      if (outModel != null)
        if (Widget_$this.outNumDim) {
          if (Widget_$this.outType === 0) {
            let array = outModel;
            if (!Widget_$this.outWidget.size()) {
              let windows = (function init$Array () {
                let _d0 = array.size();
              ...
              Widget_$this.outWidget = new Main_$this.QEDExplicitArray(new Main_$this.ViewArray_(windows, array.getDirs(Widget_$this.directive.direction), Main_$this.resizeViewObj, Main_$this.paintViewObj, Main_$this.onViewEventObj, Main_$this.getViewElementRectObj));
            }
            ...
            if (Widget_$this.outType === 1) {
              let viewArray = new Main_$this.ViewArray_(outModel, new Main_$this.QEDExplicitArray(Widget_$this.directive.direction & 1, (Widget_$this.directive.direction & 2 ? 1 : 0)), Main_$this.resizeViewString, Main_$this.paintViewString, Main_$this.onViewEventString, Main_$this.getViewElementRectString);
              Widget_$this.outWidget = new Main_$this.QEDExplicitArray(viewArray);
            }
            else
              if (Widget_$this.outType === 2) {
                let viewArray = new Main_$this.ViewArray_(outModel, new Main_$this.QEDExplicitArray(Widget_$this.directive.direction & 1, (Widget_$this.directive.direction & 2 ? 1 : 0)), Main_$this.resizeViewImage, Main_$this.paintViewImage, Main_$this.onViewEventImage, Main_$this.getViewElementRectImage);
                Widget_$this.outWidget = new Main_$this.QEDExplicitArray(viewArray);
              }
        }
        else
          if (Widget_$this.outType === 0) {
            let window = _refreshViews(outModel, Widget_$this.outWidget);
            Widget_$this.outWidget = window;
          }
    }
    else
      if (Widget_$this.outType >= 0)
        Widget_$this.outType += 1 + 3 - 4;
    {
      let ndx = 0;
      while(ndx < Widget_$this.directive.atts.size()) {
        if (Main_$this.isAreaHeritable(Widget_$this.directive.atts[ndx].code))
          Main_$this.pushAttribute_$_$(Widget_$this.directive.atts[ndx].code, Widget_$this.directive.atts[ndx].value);
        ndx++;
      }
    }
    if (Widget_$this.subWidgets.size()) {
      let previous = new Main_$this.QEDExplicitArray();
      Widget_$this.count = 0;
      {
        let index = 0;
        while(index < Widget_$this.subWidgets.size()) {
          let sub = Widget_$this.subWidgets[index];
          sub.recalcLayout();
          if (Main_$this.hasAreas(sub.directive)) {
      ...
      Widget_$this.size = Widget_$this.subWidgets[Widget_$this.subWidgets.size() - 1].group;
    }
    else
      Widget_$this.size = new Main_$this.QEDExplicitArray(0, 0);
    if (Widget_$this.outType >= 0) {
      let outModel = Widget_$this.directive.outAttr[0].value;
      if (outModel != null)
        if (Widget_$this.outNumDim) {
          if (Widget_$this.outType === 0) {
            (Widget_$this.outWidget[0]).recalcLayout();
            Widget_$this.size = (Widget_$this.outWidget[0]).size;
          }
          else
            if (Widget_$this.outType === 1) {
              (Widget_$this.outWidget[0]).recalcLayout();
          ...
          if (Widget_$this.outType === 0) {
            let window = Widget_$this.outWidget;
            if (window.size()) {
              window[0].recalcLayout();
              Widget_$this.size = window[0].size;
            }
            else
              Widget_$this.size = new Main_$this.QEDExplicitArray(0, 0);
          }
            ...
            if (Widget_$this.outType === 1)
              Widget_$this.size = Main_$this.getTextSize(outModel);
            else
              if (Widget_$this.outType === 2)
                Widget_$this.size = Main_$this.getImageSize(outModel);
    }
    if (Widget_$this.directive.sizeAttr.size())
      Widget_$this.size = (function init$Array () {
        let _d0 = 2;
        return (new Main_$this.QEDArray((function l (pos) {
          let i = pos[0];
  ...
  this.paint = function (pos0, pos1, size0, size1, fast) {
    ...
    let changeCtx = false;
    if (!fast || Widget_$this.directive.changeLevel !== RefreshLevel.NONE || Widget_$this.directive.subChangeLevel !== RefreshLevel.NONE) {
      ...
      if (outType >= 0 && directive.outAttr[0].value != null) {
        ...
        let subFast = fast && outType === 0 && Widget_$this.directive.changeLevel <= RefreshLevel.RESIZE;
        changeCtx = fast && !subFast;
        if (changeCtx)
          Main_$this.pushCanvas(pos0, pos1, size0, size1);
        if (outNumDim) {
          let viewArray = Widget_$this.outWidget[0];
          if (viewArray)
    ...
    if (!fast || Widget_$this.directive.subChangeLevel !== RefreshLevel.NONE) {
      ...
      if (!Widget_$this.outNumDim !== 0 && Widget_$this.outType >= 1)
        Main_$this.saveContext();
      {
        ...
        while(index < subSize) {
          ...
          if (sub && sub.size) {
            ...
            let subFast = fast;
            if (subFast && Widget_$this.directive.direction === 0)
              subFast = sub.directive.changeLevel !== RefreshLevel.NONE || sub.directive.subChangeLevel !== RefreshLevel.NONE;
            Widget_$this.subWidgets[index].paint(pos0 + rect[0], pos1 + rect[1], rect[2], rect[3], subFast);
          }
          index++;
        }
      }
  ...
  this.count = 0;
  this.subWidgets = (function init$Array () {
  ...
  this.directive.changeLevel = RefreshLevel.RESIZE;
};
...
this.Window_ = function (obj, dialog) {
  this.obj = obj;
  this.dialog = dialog;
  const Window_$this = this;
  this.recalcLayout = function () {
    if (Window_$this.dialog.size())
      Window_$this.dialog[0].recalcLayout();
    let previous = new Main_$this.QEDExplicitArray();
    {
      let index = 0;
    ...
    Window_$this.size = (Window_$this.widgets.size() ? Window_$this.widgets[Window_$this.widgets.size() - 1].group : new Main_$this.QEDExplicitArray(0, 0));
    if (Window_$this.dialog.size())
      Window_$this.size = (function init$Array () {
        let _d0 = 2;
        return (new Main_$this.QEDArray((function l (pos) {
          let i = pos[0];
  ...
  this.paint = function (pos0, pos1, size0, size1, fast) {
    this.obj.refreshLevel = RefreshLevel.NONE;;
    {
      let index = 0;
      while(index < Window_$this.widgets.size()) {
        let sub = Window_$this.widgets[index];
    ...
    if (Window_$this.dialog.size())
      Window_$this.dialog[0].paint(pos0, pos1, size0, size1, fast);
  };
  this.onEvent = function (event, location, size) {
    let flag = false;
    if (Window_$this.dialog.size())
...
function _refreshViews (obj, window) {
  if (obj.qedModel) {
    if (!window.length || window[0].obj !== obj)
      window = new Main_$this.QEDExplicitArray(new Main_$this.Window_(obj, new Main_$this.QEDExplicitArray()));
    if (obj.blocking__Call)
...
this.VoidFn = class VoidFn extends QEDObject {
  constructor(context__Call) {
    super(context__Call);
    const VoidFn$this = this;
  }
};
this.QedAudioLoader = class QedAudioLoader extends QEDObject {
  constructor(url, context__Call) {
    super(context__Call);
    this.url = url;
    const QedAudioLoader$this = this;
    this.Aud = class Aud extends QEDObject {
      constructor(context__Call) {
        super(context__Call);
        const Aud$this = this;
        QedAudioLoader$this.audio.play();
    QedAudioLoader$this.audio.onended = function(event) {
      _qedCallback(Aud$this, null);
    };
      }
    };
    this.audio = new Audio(url);
    QedAudioLoader$this.audio.addEventListener("canplaythrough", function audioListener(event) {
    QedAudioLoader$this.audio.removeEventListener("canplaythrough", audioListener);
    _qedCallback(QedAudioLoader$this, QedAudioLoader$this.Aud)
  });
  }
};
this.sin = function (a) {
...
this.QedInterval = class QedInterval extends QEDObject {
  constructor(timeoutMillis, context__Call) {
    super(context__Call);
    this.timeoutMillis = timeoutMillis;
    const QedInterval$this = this;
    setInterval(function() {
    _qedCallback(QedInterval$this, null);
  }, timeoutMillis);
  }
};
this.QedKeyEvent = class QedKeyEvent extends QEDObject {
  constructor(context__Call) {
    super(context__Call);
    const QedKeyEvent$this = this;
    this.waitUserTrigger_ = function () {
      QedKeyEvent$this.trigger = _bindHandler(new Main_$this.QedYield(QedKeyEvent$this), (function Lambda_ (_ret) {
        if (!QedKeyEvent$this._isActive())
          return;
        {
          QedKeyEvent$this.waitUserTrigger_();
          {
            Main_$this.post_(QedKeyEvent$this, QedKeyEvent$this.keyCode);
            return;
          }
        }
      }));
    };
    this.fetchKeyCode = function (code) {
      QedKeyEvent$this.keyCode = code;
      Main_$this.qedResume(QedKeyEvent$this.trigger);
    };
    this.keyCode = 0;
    this.trigger = null;
    canvas.tabIndex = 1;
  canvas.onkeydown = function keyDown(e) {
    QedKeyEvent$this.fetchKeyCode(e.keyCode);
  };
  ...
  ctx.setTransform(1, 0, 0, 1, 0, 0);
    ...
    this.KeyButton = class KeyButton extends QEDObject {
      constructor(text, context__Call) {
        ...
        this.refresh_Model_ = function () {
          ...
          _level = Main_$this.max(_level, lvl_$);
          return _level;
        };
    ...
    this.SpinnerWidget = class SpinnerWidget extends QEDObject {
      constructor(context__Call) {
        ...
        (function while191$_ () {
          if (true) {
            SpinnerWidget$this._qedSetBlockingCall(_bindHandler(new Main_$this.QedAnimation(SpinnerWidget$this.context__Call), (function Lambda_ (_ret192$_) {
              if (!SpinnerWidget$this._isActive())
                return;
              SpinnerWidget$this._qedEndCall();
              SpinnerWidget$this.angle = _ret192$_ / 2000 * 2 * 3.141593;
              while191$_();
            })));
          }
          else
      ...
      constructor(entry, context__Call) {
        ...
        this.NextPane = class NextPane extends QEDObject {
          constructor(context__Call) {
            ...
            NextPane$this._qedSetBlockingCall(_bindHandler(new GetTransactionEntry$this.SetPane(GetTransactionEntry$this.paneIndex + 1, NextPane$this.context__Call), (function Lambda_ () {
        ...
        this.panes = new Main_$this.QEDExplicitArray(new this.Pane("Count", (_bindHandler(new Main$this.NumTacosWidget(GetTransactionEntry$this), (function Lambda_ (_ret) {
            ...
            return;
          {
            ...
            GetTransactionEntry$this._qedSetBlockingCall(_bindHandler(new GetTransactionEntry$this.NextPane(GetTransactionEntry$this.context__Call), (function Lambda_ () {
              if (!GetTransactionEntry$this._isActive())
                return;
        ...
        this.titles = (function init$Array () {
          ...
          return (new Main_$this.QEDArray((function l (pos) {
            ...
            return (_bindHandler((new GetTransactionEntry$this.TabLabel(pane, GetTransactionEntry$this)), (function Lambda_ () {
              if (!GetTransactionEntry$this._isActive())
                return;
              GetTransactionEntry$this._qedSetBlockingCall(_bindHandler(new GetTransactionEntry$this.SetPane(pane, GetTransactionEntry$this.context__Call), (function Lambda_ () {
                if (!GetTransactionEntry$this._isActive())
                  return;
                GetTransactionEntry$this._qedEndCall();
              })));
        ...
        GetTransactionEntry$this._qedSetBlockingCall(_bindHandler(new this.SetPane(0, GetTransactionEntry$this.context__Call), (function Lambda_ () {
          if (!GetTransactionEntry$this._isActive())
            return;
          GetTransactionEntry$this._qedEndCall();
    ...
    this.OrderTacos = class OrderTacos extends QEDObject {
      constructor(transactionEntry, context__Call) {
        ...
        OrderTacos$this._qedSetBlockingCall(_bindHandler(new Main_$this.QedTimer(5000, OrderTacos$this.context__Call), (function Lambda_ (_ret231$_) {
    ...
    this.DisplaySuccess = class DisplaySuccess extends QEDObject {
      constructor(total, context__Call) {
        ...
        DisplaySuccess$this._qedSetBlockingCall(_bindHandler(new Main_$this.QedTimer(5000, DisplaySuccess$this.context__Call), (function Lambda_ (_ret233$_) {
    ...
    this.Application = class Application extends QEDObject {
      constructor(context__Call) {
        ...
        (function while239$_ () {
          if (true) {
            Application$this._qedSetBlockingCall(_bindHandler(new Main$this.MainScreen(Application$this.context__Call), (function Lambda_ (_ret240$_) {
              if (!Application$this._isActive())
                return;
              Application$this._qedEndCall();
              let choice = _ret240$_;
              new (function W253$_ (i241$_) {
                this.i241$_ = i241$_;
                if (choice === 1) {
                  let entry = new Main$this.TransactionEntry(Application$this);
                  Application$this._qedSetBlockingCall(_bindHandler(new Main$this.GetTransactionEntry(entry, Application$this.context__Call), (function Lambda_ (_ret242$_) {
                    if (!Application$this._isActive())
                      return;
                    Application$this._qedEndCall();
                    new (function W250$_ (i243$_) {
                      this.i243$_ = i243$_;
                      if (_ret242$_) {
                        Application$this._qedSetBlockingCall(_bindHandler(new Main$this.OrderTacos(entry, Application$this.context__Call), (function Lambda_ (_ret244$_) {
                          if (!Application$this._isActive())
                            return;
                          Application$this._qedEndCall();
                          new (function W248$_ (i245$_) {
                            this.i245$_ = i245$_;
                            if (_ret244$_) {
                              Main$this.qedModel[0].children[0].setAtt(0, Main_$this.oval);
                              Application$this._qedSetBlockingCall(_bindHandler(new Main$this.DisplaySuccess(entry.getTotal(), Application$this.context__Call), (function Lambda_ () {
                                if (!Application$this._isActive())
                                  return;
                                Application$this._qedEndCall();
                                Main$this.qedModel[0].children[0].setAtt(0, Main_$this.oval);
